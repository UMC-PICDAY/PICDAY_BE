...
const models: TsoaRoute.Models = {
  WishlistItemDto: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        studioName: { dataType: "string", required: true },
        studioId: { dataType: "double", required: true },
  ...
  GetWishlistsResponseDto: {
    ...
    type: {
      ...
      nestedProperties: {
        items: {
          dataType: "array",
          array: { dataType: "refAlias", ref: "WishlistItemDto" },
          required: true,
        },
  ...
  GetWishlistsSuccessResponseDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        data: { ref: "GetWishlistsResponseDto", required: true },
  ...
  AddWishlistSuccessResponseDto: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        message: { dataType: "string", required: true },
        code: { dataType: "enum", enums: ["COMMON_201"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
      },
      validators: {},
    },
  ...
  infer_typeofaddWishlistRequestSchema_: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: { studioId: { dataType: "double", required: true } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  output_typeofstudioDetailResponseSchema_: {
    ...
    type: {
      ...
      nestedProperties: {
          ...
          nestedProperties: {
            previewReview: {
              ...
              nestedProperties: {
                ...
                rating: { dataType: "double", required: true },
                isBest: { dataType: "boolean", required: true },
                writerNickname: { dataType: "string", required: true },
              },
            },
        ...
        hairMakeupPartnerCount: { dataType: "double", required: true },
        studioInfo: {
          dataType: "nestedObjectLiteral",
          nestedProperties: {
            refundGuide: {
        ...
        serviceCodes: {
          ...
          array: {
            dataType: "union",
            subSchemas: [
              { dataType: "enum", enums: ["HAIR_MAKEUP"] },
              { dataType: "enum", enums: ["PARKING"] },
              { dataType: "enum", enums: ["COSTUME"] },
              { dataType: "enum", enums: ["WIFI"] },
            ],
          },
          required: true,
        },
        representativeProducts: {
          ...
          array: {
            ...
            nestedProperties: {
              ...
              studioProductId: { dataType: "string" },
        ...
        location: {
          dataType: "nestedObjectLiteral",
          nestedProperties: {
            walkingMinutes: { dataType: "double" },
            nearestStation: { dataType: "string" },
            ...
            locationCategory: {
              dataType: "union",
              subSchemas: [
                { dataType: "enum", enums: ["HONGDAE"] },
                { dataType: "enum", enums: ["GANGNAM"] },
                { dataType: "enum", enums: ["SEONGSU"] },
                { dataType: "enum", enums: ["YEONNAM"] },
                { dataType: "enum", enums: ["KONDAE"] },
                { dataType: "enum", enums: ["SINCHON"] },
                { dataType: "enum", enums: ["JAMSIL"] },
                { dataType: "enum", enums: ["APGUJEONG"] },
                { dataType: "enum", enums: ["HYEHWA"] },
                { dataType: "enum", enums: ["JONGNO"] },
              ],
            },
            stationLineCodes: {
              dataType: "array",
        ...
        isWishlisted: { dataType: "boolean", required: true },
        imageUrls: {
          dataType: "array",
          array: { dataType: "string" },
          required: true,
  ...
  GetStudioSlotsSuccessResponseDto: {
    dataType: "refAlias",
    type: {
      ref: "output_typeofgetStudioSlotsSuccessResponseSchema_",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
          ...
          array: {
            ...
            nestedProperties: {
              products: {
                ...
                array: {
                  ...
                  nestedProperties: {
                    ...
                    studioProductId: { dataType: "string" },
                    basePeople: { dataType: "double", required: true },
                    price: { dataType: "double", required: true },
                    imageUrls: {
                      dataType: "array",
                      array: { dataType: "string" },
              ...
              shootingCategory: {
                dataType: "union",
                subSchemas: [
                  { dataType: "enum", enums: ["ID_PHOTO"] },
                  { dataType: "enum", enums: ["PROFILE"] },
                  { dataType: "enum", enums: ["PERSONAL_PORTRAIT"] },
                  { dataType: "enum", enums: ["JOB_PHOTO"] },
                  { dataType: "enum", enums: ["FAMILY"] },
                  { dataType: "enum", enums: ["FRIENDSHIP"] },
                ],
                required: true,
              },
            },
  ...
  GetStudioProductsSuccessResponseDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        data: { ref: "StudioProductsResponseDto", required: true },
        message: {
          dataType: "enum",
          enums: ["사진관 컨셉 목록 조회에 성공했습니다."],
          required: true,
        },
        code: { dataType: "enum", enums: ["COMMON_200"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
  ...
  StudioProductDetailResponseDto: {
    dataType: "refAlias",
    type: {
      ref: "output_typeofstudioProductDetailResponseSchema_",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    type: {
      ...
      nestedProperties: {
        data: {
          dataType: "union",
          subSchemas: [
            { ref: "StudioProductDetailResponseDto" },
            { dataType: "enum", enums: [null] },
          ],
          required: true,
        },
      ...
      nestedProperties: {
        suggestions: {
          ...
          array: {
            dataType: "nestedObjectLiteral",
            nestedProperties: {
              studioId: { dataType: "double" },
              locationCategory: { dataType: "string", required: true },
              studioName: { dataType: "string", required: true },
            },
          },
          required: true,
  ...
  StudioAutocompleteResponseDto: {
    dataType: "refAlias",
    type: {
      ref: "output_typeofstudioAutocompleteResponseSchema_",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  GetStudioAutocompleteSuccessResponseDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        data: { ref: "StudioAutocompleteResponseDto", required: true },
        message: {
          dataType: "enum",
          enums: ["사진관 자동완성 조회에 성공했습니다."],
          required: true,
        },
        code: { dataType: "enum", enums: ["STUDIO_200"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
      },
      validators: {},
    },
  ...
  infer_typeofreviewKeywordSchema_: {
    ...
    type: {
      dataType: "union",
      subSchemas: [
        { dataType: "enum", enums: ["KIND_SERVICE"] },
        { dataType: "enum", enums: ["DETAILED_RETOUCH"] },
        { dataType: "enum", enums: ["ON_TIME"] },
        { dataType: "enum", enums: ["COMFORTABLE_MOOD"] },
        { dataType: "enum", enums: ["REASONABLE_PRICE"] },
        { dataType: "enum", enums: ["SATISFYING_RESULT"] },
      ],
      validators: {},
    },
  },
  ...
  ReviewListItemDto: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        keywords: {
          dataType: "array",
          array: { dataType: "refAlias", ref: "ReviewKeywordValue" },
          required: true,
        },
        content: { dataType: "string", required: true },
        rating: { dataType: "double", required: true },
  ...
  GetReviewsResponseDto: {
    ...
    type: {
      ...
      nestedProperties: {
        items: {
          dataType: "array",
          array: { dataType: "refAlias", ref: "ReviewListItemDto" },
          required: true,
        },
        size: { dataType: "double", required: true },
        page: { dataType: "double", required: true },
        summary: {
          dataType: "nestedObjectLiteral",
          nestedProperties: {
            photoReviewCount: { dataType: "double", required: true },
            totalCount: { dataType: "double", required: true },
  ...
  GetReviewsSuccessResponseDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        data: { ref: "GetReviewsResponseDto", required: true },
        message: { dataType: "string", required: true },
        code: { dataType: "enum", enums: ["COMMON_200"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
      },
  ...
  infer_typeofcreateReviewRequestSchema_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        content: { dataType: "string", required: true },
        rating: { dataType: "double", required: true },
        reservationId: { dataType: "double", required: true },
      },
      validators: {},
    },
  },
  ...
  AddReviewLikeSuccessResponseDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        data: { ref: "ReviewLikeResponseDto", required: true },
        message: { dataType: "string", required: true },
        code: { dataType: "enum", enums: ["COMMON_201"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
      },
    ...
    type: {
      ...
      nestedProperties: {
        data: {
          ...
          nestedProperties: {
            createdAt: { dataType: "string" },
            reservationId: { dataType: "string" },
            totalPrice: { dataType: "double", required: true },
            status: { dataType: "enum", enums: ["RESERVED"], required: true },
          },
          required: true,
        },
        message: {
          dataType: "enum",
          enums: ["예약이 성공적으로 완료되었습니다."],
          required: true,
        },
        code: { dataType: "enum", enums: ["COMMON_201"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
  ...
  CreateReservationSuccessResponseDto: {
    dataType: "refAlias",
    type: {
      ref: "output_typeofcreateReservationSuccessResponseSchema_",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    type: {
      ...
      nestedProperties: {
        ...
        paymentMethod: {
          dataType: "union",
          subSchemas: [
            { dataType: "enum", enums: ["KAKAOPAY"] },
            { dataType: "enum", enums: ["NAVERPAY"] },
            { dataType: "enum", enums: ["TOSSPAY"] },
            { dataType: "enum", enums: ["TRANSFER"] },
            { dataType: "enum", enums: ["CARD"] },
          ],
          required: true,
        },
        reserveePhone: { dataType: "string", required: true },
        reserveeName: { dataType: "string", required: true },
        timeSlotId: { dataType: "double", required: true },
        studioProductId: { dataType: "double", required: true },
        studioId: { dataType: "double", required: true },
      },
      validators: {},
    },
  ...
  CreateReservationRequestDto: {
    dataType: "refAlias",
    type: {
      ref: "infer_typeofcreateReservationRequestSchema_",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
            ...
            subSchemas: [
              {
                ...
                array: {
                  dataType: "nestedObjectLiteral",
                  nestedProperties: {
                    reservationDate: { dataType: "string" },
                    reservationId: { dataType: "string" },
                    status: {
                      dataType: "union",
                      subSchemas: [
                    ...
                    totalPrice: { dataType: "double", required: true },
                    reservationTime: { dataType: "string", required: true },
                    conceptName: { dataType: "string", required: true },
                    studioName: { dataType: "string", required: true },
                  },
                },
              },
  ...
  UploadImageSuccessResponseDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        data: { ref: "UploadImageResponseDto", required: true },
        message: { dataType: "string", required: true },
        code: { dataType: "enum", enums: ["COMMON_201"], required: true },
        success: { dataType: "enum", enums: [true], required: true },
      },
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  "ApiResponse__id-string--createdAt-Date--status-UserStatus--name-string--loginId-string--nickname-string--email-string--phoneNumber-string--provider-Provider--refreshToken-string--updatedAt-Date--deletedAt-Date__":
    {
      dataType: "refAlias",
      type: {
        dataType: "nestedObjectLiteral",
...
export function RegisterRoutes(
  ...
  app.get(
    ...
    async function WishlistController_list(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsWishlistController_list,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function WishlistController_add(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsWishlistController_add,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsWishlistController_remove: Record<
    string,
  ...
  app.delete(
    ...
    async function WishlistController_remove(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsWishlistController_remove,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsStudioController_getStudioDetail: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    studioId: {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      StudioController.prototype.getStudioDetail,
    ),

    async function StudioController_getStudioDetail(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsStudioController_getStudioDetail,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsStudioController_getStudioSlots: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    studioId: {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StudioController),
    ...fetchMiddlewares<RequestHandler>(
      StudioController.prototype.getStudioSlots,
    ),

    async function StudioController_getStudioSlots(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsStudioController_getStudioSlots,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsStudioController_getStudioProducts: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    studioId: {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StudioController),
    ...fetchMiddlewares<RequestHandler>(
      StudioController.prototype.getStudioProducts,
    ),

    async function StudioController_getStudioProducts(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsStudioController_getStudioProducts,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsStudioController_getStudioProductDetail: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    studioId: {
  ...
  app.get(
    "/api/v1/studios/:studioId/products/:studioProductId",
    ...fetchMiddlewares<RequestHandler>(StudioController),
    ...fetchMiddlewares<RequestHandler>(
      StudioController.prototype.getStudioProductDetail,
    ),

    async function StudioController_getStudioProductDetail(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsStudioController_getStudioProductDetail,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsStudioController_getStudioAutocomplete: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    keyword: {
  ...
  app.get(
    "/api/v1/studios/autocomplete",
    ...fetchMiddlewares<RequestHandler>(StudioController),
    ...fetchMiddlewares<RequestHandler>(
      StudioController.prototype.getStudioAutocomplete,
    ),

    async function StudioController_getStudioAutocomplete(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsStudioController_getStudioAutocomplete,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsStudioReviewController_listByStudio: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    studioId: {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      StudioReviewController.prototype.listByStudio,
    ),

    async function StudioReviewController_listByStudio(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsStudioReviewController_listByStudio,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ReviewController_create(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReviewController_create,
          request,
          response,
        });
  ...
  app.patch(
    ...
    async function ReviewController_update(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReviewController_update,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function ReviewController_remove(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReviewController_remove,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsReviewController_addLike: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    reviewId: {
  ...
  app.post(
    ...
    async function ReviewController_addLike(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReviewController_addLike,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsReviewController_removeLike: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    reviewId: {
  ...
  app.delete(
    ...
    async function ReviewController_removeLike(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReviewController_removeLike,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsReservationController_create: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    body: {
      ...
      name: "body",
      required: true,
      ref: "CreateReservationRequestDto",
    },
    request: {
      in: "request",
      name: "request",
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsReservationController_cancel: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    reservationId: {
  ...
  app.patch(
    ...
    async function ReservationController_cancel(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_cancel,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsReservationController_detail: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    reservationId: {
  ...
  app.get(
    ...
    async function ReservationController_detail(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_detail,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsReservationController_list: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    request: {
  ...
  app.get(
    ...
    async function ReservationController_list(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function ImageController_upload(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsImageController_upload,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsAuthController_checkLoginId: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
  ...
  app.get(
    ...
    async function AuthController_checkLoginId(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_checkLoginId,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsAuthController_checkNickname: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
  ...
  app.get(
    ...
    async function AuthController_checkNickname(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_checkNickname,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function AuthController_getMe(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.patch(
    ...
    async function AuthController_updateMe(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_updateMe,
          request,
          response,
        });
